...
1. `V001__users_roles_schema.sql`
2. `V002__cars_spare_parts_schema.sql`
3. `V003__common_orders_schema.sql`
4. `V004__custom_orders_schema.sql`
5. `V005__test_drives_schema.sql`
6. `V006__seed_data.sql`
7. `V007__security.sql`

Миграции описаны в `migrations/db.changelog-master.yaml`.
